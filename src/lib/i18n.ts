const messages = {
  'zh-CN': {
    ...
    market: {
      ...
      industry: '行业',
      radarTitle: '每日机会雷达',
      radarSubtitle: '基于趋势、资金、筹码、情绪与基本面的每日机会筛选',
      radarBubbleChart: '机会气泡图',
      radarXAxis: '资金净流入(亿)',
      radarYAxis: '今日涨幅',
      radarScore: '牛眼评分',
      radarLocked: '需解锁',
      radarPaywallTitle: '解锁完整机会雷达',
      radarPaywallDesc: '邀请好友或升级 VIP 可查看全部机会代码、买入参考区间与完整分析。',
      radarUpgradeVip: '升级 VIP',
      radarInviteFriend: '邀请好友',
      radarInvitePhonePlaceholder: '输入好友手机号（11位）',
      radarInviteNeedLogin: '请先登录后再邀请好友',
      radarInviteCreateSuccess: '邀请记录已创建，待好友注册并绑定邀请码后自动完成解锁追踪',
      radarInviteCreateFailed: '邀请创建失败，请检查手机号',
      radarShareTitle: '雷达分享卡片',
      radarShareSubtitle: '牛眼 AI 每日机会雷达',
