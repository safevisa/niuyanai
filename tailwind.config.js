  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        scoreFill: { '0%': { strokeDashoffset: '283' }, '100%': { strokeDashoffset: 'var(--dash-offset)' } },
      },
      backgroundImage: {
        ...
        'gradient-bull':      'linear-gradient(135deg, #22c55e, #16a34a)',
        'gradient-bear':      'linear-gradient(135deg, #ef4444, #dc2626)',
      },
      backdropBlur: { xs: '2px' },
